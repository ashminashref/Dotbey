    ...
    <section className="py-24 bg-white text-slate-900 border-t border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-[#0052FF] text-xs font-semibold uppercase tracking-wider mb-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-semibold tracking-tight text-slate-900">
            Engineered to make your brand <span className="font-accent italic font-normal text-[#0052FF]">stand out.</span>
          </h2>
          ...
          {capabilities.map((cap, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-slate-50/70 border border-slate-200/90 rounded-3xl p-7 flex flex-col justify-between hover:bg-white hover:border-[#0052FF]/40 hover:shadow-xl transition-all duration-300"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-12 h-12 rounded-2xl bg-white border border-slate-200 flex items-center justify-center text-[#0052FF] shadow-sm group-hover:bg-[#0052FF] group-hover:text-white transition-colors">
                      <IconComp className="w-6 h-6" />
                    </div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[#0052FF] bg-blue-50 border border-blue-100 px-2.5 py-1 rounded-md">
                      {cap.badge}
                    </span>
                  </div>

                  <h3 className="text-xl font-bold text-slate-900 mb-1 group-hover:text-[#0052FF] transition-colors">
                    {cap.title}
                  </h3>
